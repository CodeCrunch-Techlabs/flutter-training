...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _addNewTransaction(String txTitle, double txAmount, DateTime chosenData){
    final newTx =  Transaction(title: txTitle, amount: txAmount, date: chosenData, id:DateTime.now().toString());
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(icon: Icon(Icons.add), onPressed: () => openAddTransactionForm(context),)
          ],
        ),
