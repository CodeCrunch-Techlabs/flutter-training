...
class NewsSearchEntity extends Equatable {
  final int id;
  ...
  NewsSearchEntity(this.id, this.titleEn, this.date, this.postLink,
  ...
  static NewsSearchEntity fromJson(Map<String, Object> json) {
    return NewsSearchEntity(
      json['id'] as int,
